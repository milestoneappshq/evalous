-- CreateEnum
CREATE TYPE "Role" AS ENUM ('SUPER_ADMIN', 'ORG_ADMIN', 'CANDIDATE');

-- CreateEnum
CREATE TYPE "TestStatus" AS ENUM ('PENDING', 'STARTED', 'COMPLETED');
...
-- AddForeignKey
ALTER TABLE "test_assignments" ADD CONSTRAINT "test_assignments_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "test_assignments" ADD CONSTRAINT "test_assignments_job_id_fkey" FOREIGN KEY ("job_id") REFERENCES "jobs"("id") ON DELETE SET NULL ON UPDATE CASCADE;
